...
<gameSystem id="c138ada2-95db-4a25-7d44-b8c80b632d36" name="Warhammer 40,000: Heralds of Ruin Kill Team expansion" revision="23" battleScribeVersion="2.00" authorName="BSData organisation" authorContact="@BSData" authorUrl="https://github.com/BSData/" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <forceEntries>
    <forceEntry id="844f-055c-4c85-ae4c" name="Choose Another Force Entry" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <constraints/>
      <categoryEntries>
        <categoryEntry id="288d-5335-4ae8-cce5" name="-" hidden="false">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <constraints>
            <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="false" includeChildSelections="false" includeChildForces="false" id="3a53-e188-3fca-74df" type="min"/>
          </constraints>
        </categoryEntry>
      </categoryEntries>
      <forceEntries/>
  ...
  <sharedSelectionEntries>
    <selectionEntry id="ee11-ac90-d4c4-a275" name="Carapace Armour" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="ea7d-75e9-5882-c0b2" name="Carapace Armour" hidden="true" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="Grants the model a 4+ armour save."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="1613-ba16-ec57-b158" name="Bolt Pistol" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="0342-2a31-9e7a-92f6" name="Bolt Pistol" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="3843-58ca-6f81-9757" name="Frag Grenade" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="8c4d-5597-e4d7-569f" name="Frag Grenade" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="8134-80b8-d626-a410" name="Frag Grenade" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="Models equipped with Frag Grenades don’t suffer the penalty to their Initiative for charging enemies through difficult terrain, but fight at their normal Initiative in the ensuing combat."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="010f-68cf-1eab-d3f3" name="Boltgun" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="c450-b21f-3a5b-e556" name="" hidden="false" targetId="13ee-5199-b4f3-747f" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="181e-42d6-a884-a5ca" name="Combi-Flamer" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="d652-eb07-e6d4-2ae9" name="" hidden="false" targetId="484d-580b-674c-520f" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="cd8f-8910-2323-afb0" name="" hidden="false" targetId="13ee-5199-b4f3-747f" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="ef5b-83f4-24eb-8f9a" name="" hidden="false" targetId="d33a-f347-4961-4044" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="5673-738f-943e-d0d6" name="" hidden="false" targetId="73d5-cc81-ffd9-3393" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="4207-0364-0286-08df" name="Combi-Melta" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="f983-c19e-de0d-410e" name="" hidden="false" targetId="13ee-5199-b4f3-747f" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="4247-75be-3250-996b" name="" hidden="false" targetId="484d-580b-674c-520f" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="36ab-a314-9e63-6386" name="" hidden="false" targetId="844c-faa7-5c09-5d8c" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="4433-5689-eb46-5251" name="" hidden="false" targetId="f585-411d-dacc-cabc" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="815f-6138-c263-9b4b" name="Combi-Plasma" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="58f3-f619-b39f-aea5" name="" hidden="false" targetId="484d-580b-674c-520f" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="3c6e-a40c-ec09-2348" name="" hidden="false" targetId="13ee-5199-b4f3-747f" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="d4dd-1ae1-1e8e-9832" name="" hidden="false" targetId="aca3-414b-650e-9371" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="d14c-3788-4cf4-9377" name="" hidden="false" targetId="f922-9f18-5263-c23a" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="43a9-eb82-8508-22c6" name="Power Axe" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="3479-53f0-1cd0-a7d7" name="Power Axe" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="11f2-65b1-e437-c8f9" name="New InfoLink" hidden="false" targetId="11c6-e9de-18cc-249e" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="fa75-bbf7-6105-debd" name="Power Lance" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="ff0c-08f5-8f7a-4ba4" name="Power Lance" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="5a37-9c34-b183-c4f2" name="Power Lance" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="* Power lances have two profiles for both Strength and AP. The first is used only on a turn in which a model charges; the second is used at all other times."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="26a2-8df8-d1ee-ba4b" name="Power Maul" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="d391-93cc-3299-d727" name="Power Maul" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="0f98-58ae-8cc3-a6c9" name="New InfoLink" hidden="false" targetId="d4bc-4e4e-1420-3763" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="8d7d-94b8-5ca4-7e5e" name="Power Sword" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="fa79-49c3-4c3e-9ac3" name="Power Sword" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="2baa-b75f-4a07-b9fa" name="Plasma Pistol" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="a105-68b1-ec49-1dbd" name="Plasma Pistol" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="5eda-755d-f41a-1f9b" name="" hidden="false" targetId="aca3-414b-650e-9371" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="4298-415f-6a31-8c54" name="Hand Flamer" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="c14b-1f5b-7b9e-b231" name="Hand Flamer" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="38ed-df0d-8ebd-5d2e" name="Power Fist" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="f98e-7770-268c-e403" name="Power Fist" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="cf4d-9b84-217d-8fca" name="New InfoLink" hidden="false" targetId="87dd-bcd9-faff-9ed7" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="84ac-ddd6-164b-bf09" name="New InfoLink" hidden="false" targetId="11c6-e9de-18cc-249e" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="bf3c-892d-c280-db54" name="Krak Grenade" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="fcfa-a7d6-d074-b031" name="Krak Grenade" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="31c6-c028-a11c-bdd5" name="Krak Grenade" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="58bf-30ec-46d4-3f68" name="Krak Grenade" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="ee96-fe0a-b137-020a" name="Camo Cloak" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="9398-a077-5999-f0f5" name="Camo Cloak" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="A model wearing a Camo Cloak has +1 armour save. If it does not already have a cover save, it gains a 6+ cover save."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="b85c-998f-edf8-142d" name="Melta Bomb" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="8d30-fe0a-f669-c154" name="Melta Bomb" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            ...
            <characteristic name="Type" characteristicTypeId="077c342f-d7b9-45c6-b8af-88e97cafd3a2" value="Melee, Armourbane, Unwieldy"/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
      <infoLinks>
        <infoLink id="cccc-0905-c701-595b" name="New InfoLink" hidden="false" targetId="461b-116e-2c9f-62ba" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="a6ff-9df3-e51d-032f" name="New InfoLink" hidden="false" targetId="11c6-e9de-18cc-249e" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="b489-e0c0-13f1-4a01" name="Power Armor" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="aca4-f643-9a90-4a4b" name="Power Armor" hidden="true" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="Grants the model a 3+ armour save."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="ff9b-5525-1eb4-ac49" name="Heavy Stubber" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="67ce-23fa-aed1-da4e" name="Heavy Stubber" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="a97c-239e-d5cf-477f" name="Flamer" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="edc5-cbfe-bc39-91ff" name="" hidden="false" targetId="d33a-f347-4961-4044" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="99ab-5383-5f53-a6a0" name="" hidden="false" targetId="73d5-cc81-ffd9-3393" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="15d8-d4ab-0f48-7c68" name="Meltagun" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="df5e-a057-62b9-d9b0" name="" hidden="false" targetId="f585-411d-dacc-cabc" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="6a06-6d42-ceee-4b1e" name="" hidden="false" targetId="844c-faa7-5c09-5d8c" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="6205-33f0-ae12-e2b0" name="Plasma Gun" hidden="false" collective="false" type="upgrade">
      ...
      <rules/>
      <infoLinks>
        <infoLink id="f74d-4169-7edb-886e" name="" hidden="false" targetId="aca3-414b-650e-9371" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        </infoLink>
        <infoLink id="0b17-27b0-1da4-2084" name="" hidden="false" targetId="f922-9f18-5263-c23a" type="profile">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="57c1-6ed0-3098-9619" name="Close Combat Weapon" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="9639-f9b9-f67b-98ae" name="Close Combat Weapon" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="f446-bf98-f8a7-328b" name="Multi-laser" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="b68f-766b-c0b3-b038" name="Multi-laser" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="0b49-8122-0d82-7dcd" name="Heavy Flamer" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="b875-0597-9868-296e" name="Heavy Flamer" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="fd4d-3ae8-ef99-812b" name="" hidden="false" targetId="d33a-f347-4961-4044" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="e359-f773-52b8-4287" name="Autocannon" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="8707-f4ab-6822-0c94" name="Autocannon" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="cf29-8197-2f34-1e78" name="Missile Launcher" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="3e9d-712b-6c00-1110" name="Frag Missile" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="c0d3-48a9-725b-95e2" name="Krak Missile" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
        ...
        <profile id="9e67-aef2-1073-a1c7" name="Flakk Missile" hidden="true" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="dee0-ba7e-6d65-5700" name="" hidden="false" targetId="569a-900e-8b7d-2653" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers>
    ...
    <selectionEntry id="1ba0-e993-8f82-a0a0" name="Lascannon" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="64f8-bfdc-b7a4-cda5" name="Lascannon" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="2fc9-9569-797b-a31f" name="Searchlight" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="8d1f-b18c-b2fe-1d99" name="Searchlight" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="578a-019b-fdcf-1aa5" name="Smoke Launchers" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="6ca8-cdcf-a551-b4e0" name="Smoke Launchers" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="6f34-073b-ea65-e1c8" name="Sniper Rifle" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="9cc9-76a1-1839-fef5" name="Sniper Rifle" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
      ...
      <rules/>
      <infoLinks>
        <infoLink id="87a7-2ba6-d726-7c0b" name="New InfoLink" hidden="false" targetId="b1b3-9ff3-0bab-a496" type="rule">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
    ...
    <selectionEntry id="f290-6edb-ee95-44ed" name="Extra Armour" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="6667-c910-2da2-bfda" name="Extra Armour" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="Vehicles equipped with extra armour count Crew Stunned results from the Vehicle Damage table as Crew Shaken results instead."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="4b84-ed37-b5c9-9efe" name="Dozer Blade" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="0578-7a03-b6aa-aef5" name="Dozer Blade" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="Vehicles equipped with dozer blades treat their front armour as one higher than normal when ramming. Furthermore the vehicle can re-roll failed Dangerous Terrain tests."/>
          </characteristics>
        </profile>
      </profiles>
      <rules/>
    ...
    <selectionEntry id="bb59-f1bb-d2f1-24e4" name="Hunter-Killer Missile" hidden="false" collective="false" type="upgrade">
      <profiles>
        <profile id="71e4-141a-e777-c58d" name="Hunter-Killer Missile" hidden="false" profileTypeId="72c5eafc-75bf-4ed9-b425-78009f1efe82" profileTypeName="Wargear Item">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
          <characteristics>
            <characteristic name="Description" characteristicTypeId="21befb24-fc85-4f52-a745-64b2e48f8228" value="A hunter-killer missile is an additional weapon, fired using the vehicle’s Ballistic Skill."/>
          </characteristics>
        </profile>
        <profile id="3289-885f-0529-5be3" name="Hunter-Killer Missile" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
          <profiles/>
          <rules/>
          <infoLinks/>
          <modifiers/>
  ...
  <sharedRules>
    <rule id="d6cb-6c57-bd6c-77ba" name="Blind" book="40k BRB" page="159" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Hit units test Initiative at end of phase. Failure reduces Weapon and Ballistic skills to 1 until end of next turn.  Units cannot blind themselves nor anything without Initiative.</description>
    </rule>
    <rule id="d4bc-4e4e-1420-3763" name="Concussive" book="40k BRB" page="163" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="d33a-f347-4961-4044" name="Flamer" book="Kill Team List: Adeptus Arbites" page="1" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Uses the flamer rules in the core Kill Team rules, page 5.</description>
    </rule>
    <rule id="aca3-414b-650e-9371" name="Gets Hot" book="40k BRB" page="164" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Firing model takes wound for each 1 rolled To Hit.  Cannot Look Out, Sir.  Vehicles suffer glancing hit after failing additional 4+ save.
Once this is resolved, place a blast template over the model before he is removed as a casualty (if needs be) – any model underneath the template takes a S3 AP- hit, except the model with the weapon itself as he has already taken he brunt of the explosion!</description>
    </rule>
    <rule id="334c-cf1a-7cf5-5d6b" name="Inspiring Presence" book="Kill Team Core Rules v3.1" page="7" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Any friendly model within 6&quot; of this model may use its Leadership for all Leadership tests.</description>
    </rule>
    <rule id="5b8d-9de9-4c61-f1b5" name="Master-Crafted" book="40k BRB" page="167" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="8d69-b6ce-d7e8-4006" name="Move Through Cover" book="40k BRB" page="168" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Model automatically passes Dangerous Terrain tests. Model&apos;s unit rolls additional D6 for difficult terrain moves and charges full distance through difficult terrain.</description>
    </rule>
    <rule id="2350-6ff9-1887-698c" name="Non-Flammable" book="Kill Team Core Rules" page="7" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>The model passes all Initiative tests caused by the Flamer rule, and may never gain a Burning counter for any reason.</description>
    </rule>
    <rule id="b500-071c-f79c-fbfd" name="Pinning" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If the special rules of a unit specify that the unit can never be Pinned, the unit automatically passes Pinning tests. Such units can still Go to Ground voluntarily if they wish.</description>
    ...
    <rule id="5bcf-9fda-1fea-ca0e" name="Scout" book="40k BRB" page="171" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If a unit has both the Infiltrate and Scout special rule, that unit can deploy as per the Infiltrate special rule and then redeploy as per the Scout special rule.</description>
    ...
    <rule id="d03d-ea48-fd6a-e59a" name="Strikedown" book="40k BRB" page="172" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="06b1-b18a-8932-abd2" name="Stubborn" book="40k BRB" page="172" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="8460-7bb6-2191-f2ea" name="Acute Senses" book="BRB 2014" page="157" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When arriving via random table edge (e.g. Outflank) you may re-roll which edge.</description>
    </rule>
    <rule id="461b-116e-2c9f-62ba" name="Armourbane" book="BRB 2014" page="157" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If a model makes a shooting attack with a weapon that has this special rule, it rolls an additional D6 for armour penetration. In either case, this special rule has no effect against non-vehicle models.</description>
    ...
    <rule id="f181-d35e-7e1b-3ec5" name="Bulky" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="0821-7806-2619-1446" name="Crusader" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Roll extra die for Run moves; use highest result. Also add D3 to Sweeping Advance rolls.</description>
    </rule>
    <rule id="cb44-4b87-3579-0ab4" name="Feel No Pain" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If a unit has the Feel No Pain special rule with a number in brackets afterwards –Feel No Pain (6+), for example – then the number in brackets is the D6 result needed to discount the Wound.</description>
    ...
    <rule id="7984-9f7a-4520-f49c" name="Feel No Pain (6+)" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Roll a D6 each time an unsaved Wound is suffered. On a 5 or less, you must take the Wound as normal. On a 6+, the unsaved  Wound is discounted – treat it as having been saved.</description>
    </rule>
    <rule id="0c0a-7084-d673-aa5e" name="Furious Charge" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="cbe9-b4eb-7bd0-ebee" name="Hammer of Wrath" book="BRB 2014" page="165" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If a model with this special rule charges a building or vehicle, the hit is resolved against the Armour Value of the facing the charging model is touching. If a model with this special rule charges a building or vehicle that is a Transport or a Chariot, the hit is resolved against the building or vehicle, not the occupants or the rider.</description>
    ...
    <rule id="276c-8078-b846-c348" name="Haywire" book="BRB 2014" page="165" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Against vehicles, roll a D6 instead of rolling armor penetration. 1 = no effect, 2-5 = Glancing hit, 6 = Penetrating hit</description>
    </rule>
    <rule id="76f4-899b-9b7b-aa2e" name="Infiltrate" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="b002-5f61-caff-13ef" name="Precision Shots" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>6&apos;s rolled To Hit become Precision Shots and may be allocated to a specific model within target unit and within range and line of sight.  Characters may still Look Out, Sir.  Cannot use for snap shots or any shot that scatters.</description>
    </rule>
    <rule id="def6-2a5c-4283-3b51" name="Relentless" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="1bcb-69f1-017e-85a1" name="Shred" book="BRB 2014" page="170" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Similarly, if a model makes a shooting attack with a weapon that has the Shred special rule, it re-rolls its failed To Wound rolls.</description>
    ...
    <rule id="370b-2de3-dc87-827a" name="Shrouded" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Cover save bonuses from the Shrouded and Stealth special rules are cumulative (to a maximum of a 2+ cover save).</description>
    ...
    <rule id="b1b3-9ff3-0bab-a496" name="Sniper" book="BRB 2014" page="171" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Against vehicles, shooting attacks from weapons and models with the Sniper special rule count as Strength 4.</description>
    ...
    <rule id="87dd-bcd9-faff-9ed7" name="Specialist Weapon" book="BRB 2014" page="172" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Two weapons does not grant +1 Attack unless both are Specialist</description>
    </rule>
    <rule id="b20e-353a-90c7-ba27" name="Stealth" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>+1 cover save or 6+ in the open. Cover save bonuses from the Shrouded and Stealth special rules are cumulative (to a maximum of a 2+ cover save).</description>
    </rule>
    <rule id="ff77-10e3-19db-2114" name="Twin-linked" book="BRB 2014" page="174" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>All failed To Hit rolls are re-rolled.</description>
    </rule>
    <rule id="11c6-e9de-18cc-249e" name="Unwieldly" book="BRB 2014" page="174" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>When attacking with this weapon, pile in and fight at Initiative step 1 unless you&apos;re a Walker or Monstrous Creature.</description>
    </rule>
    <rule id="c150-94f8-2dd4-7cd5" name="Very Bulky" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="7cc1-431e-4f47-d41c" name="Zealot" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
In addition, units containing one or more models with the Zealot special rule re-roll all failed To Hit rolls during the first round of each close combat – they do not get to re-roll failed To Hit rolls in subsequent rounds.</description>
    ...
    <rule id="f4ae-1c7e-b573-a2a3" name="Two-Handed" book="BRB 2014" page="174" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>A model attacking with this weapon never receives +1 Attack fot fighting with two Melee weapons</description>
    </rule>
    <rule id="f656-6466-265a-9ce3" name="Graviton" book="BRB 2014" page="164" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>The roll needed To Wound when firing a grav-weapon is always equal to the armour save of the target, to a minimum of 6+. For example, when resolving a hit against a Space Marine in power armour you would need a 3+ To Wound. When resolving a hit against a vehicle, roll a D6 for each hit instead of rolling for armour penetration as normal. On a 1-5 nothing happens, but on a 6, the target suffers an lmmobilised result and loses a single Hull Point. Grav-weapons have no effect on buildings.</description>
    </rule>
    <rule id="258b-44dd-90f5-5940" name="Deep Strike" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
4-6 - Delayed. Because of mechanical failure or enemy action, the reinforcements are delayed. The unit is placed in Ongoing Reserves.</description>
    ...
    <rule id="5c11-33b1-b86a-45c7" name="Hit &amp; Run" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
A Hit &amp; Run move is not slowed by difficult terrain, but takes Dangerous Terrain tests as normal. It may not be used to move into base or hull contact with enemy units, and models instead stop 1&quot; away. If there are units with this rule on both sides who wish to disengage, roll-off to determine who goes first and then alternate disengaging them. If the last of these ends up no longer in combat, it Consolidates instead.</description>
    ...
    <rule id="8b84-1851-9042-05e3" name="And They Shall Know No Fear" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Furthermore, if a unit containing one or more models with this special rule is caught by a Sweeping Advance, they are not destroyed, but remain locked in combat instead.</description>
    ...
    <rule id="bf13-9636-87e4-2fc5" name="Fear" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="2c44-c969-2f11-2ac4" name="Fearless" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="9ade-28e1-c197-4f19" name="Feel No Pain (3+)" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Roll a D6 each time an unsaved Wound is suffered. On a 2 or less, you must take the Wound as normal. On a 3+, the unsaved  Wound is discounted – treat it as having been saved.</description>
    </rule>
    <rule id="1a6b-15b4-049d-fc47" name="Fleet" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>A unit composed entirely of models with this special rule can re-roll one or more of the dice when determining charge ranges (such as a single D6 from a charge range roll, for example).
Adds D3&quot; to run moves.</description>
    </rule>
    <rule id="c832-034c-f02f-03f8" name="Jink" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="844c-faa7-5c09-5d8c" name="Melta" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Ranged weapons with this special rule roll an additional D6 when rolling to penetrate a vehicle’s armour at half range or less. 
If a weapon has both the Melta and Blast special rules, measure the distance to the centre of the blast marker after it has scattered.
</description>
    </rule>
    <rule id="f55a-7ab8-c801-3811" name="Non-learning" book="HoR: Kill Team Rules v3.1" page="7" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>The model may never gain Battle Honours.</description>
    </rule>
    <rule id="8408-2500-936f-5910" name="Rage" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="6161-e500-d4eb-f6df" name="Rampage" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="bf97-1e19-225f-592d" name="Slow and Purposeful" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="245f-13ad-292b-fa91" name="Force" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Force is a blessing psychic power that targets the Psyker and his unit. All of the targets’ weapons that have the Force special rule gain the Instant Death special rule until the start of your next Psychic phase.</description>
    ...
    <rule id="d8f0-051e-fd21-660a" name="Counter-attack" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
If, when charged, the unit was already locked in combat, the Counter-attack special rule has no effect.</description>
    ...
    <rule id="9dae-1137-9bfc-dc6a" name="Daemon" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Models with the Daemon special rule have a 5+ invulnerable save, and also have the Fear
special rule.</description>
    </rule>
    <rule id="c9b2-bc45-b716-f304" name="It Will Not Die" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="3012-28a7-681f-dfa3" name="Outflank" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="0fdc-6559-9654-cbf4" name="Night Vision" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="69ca-17db-1694-3b84" name="Rending" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Rolls of 6 to wound always wound at AP2, regardless of target&apos;s toughness. Rolls of 6 to penetrate vehicle armor add D3 to the penetration.</description>
    </rule>
    <rule id="913c-9f02-129a-5b20" name="Skilled Rider" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="d7b3-6edf-66aa-0cb7" name="Adamantium Will" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Model&apos;s unit gets +1 to Deny the Witch.</description>
    </rule>
    <rule id="43bc-80aa-4432-f3a5" name="Tank Hunters" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="b9c4-1bb1-d19d-cad8" name="Fleshbane" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="ae8e-a6f2-9d6e-40ef" name="Monster Hunter" book="Warhammer 40K Rulebook" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Re-roll To Wound against Monstrous Creatures.</description>
    </rule>
    <rule id="aab6-5493-f934-ff85" name="Soul Blaze" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
At the end of each turn, roll a D6 for each unit with a Soul Blaze counter on it. On a 3 or less, the flames die out and the unit is no longer ablaze – remove your reminder counter. On a 4+, the unit takes D3 Strength 4 AP5 hits with the Ignores Cover special rule. These Wounds are Randomly Allocated. A unit cannot have more than one Soul Blaze counter on it at a time.</description>
    ...
    <rule id="5220-d286-fec6-ba8e" name="Squad" book="Kill team rules v3.1" page="7" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Some models in Kill Team do not act individually, such as swarms of Tyranids. Where this is in effect ‘Squad’ will be noted in the unit’s Special Rules and will state how many models form the unit. For example, a Guardsman Squad has the Squad (5 Guardsmen) special rule so will consist of a unit of 5 Guardsmen. Simply treat the unit as normal, using the Warhammer 40,000 rules.</description>
    </rule>
    <rule id="db9b-f2d9-cc47-16ef" name="Assault Vehicle" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="a247-167d-eb4f-887a" name="Eternal Warrior" book="Wh40k: The Rules" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    </rule>
    <rule id="7c54-1388-1be4-4a06" name="Banner" book="HoR: Kill Team Rules v3.1" page="7" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Add +1 to assault results, regardless of how many models with this rule in this combat.</description>
    </rule>
    <rule id="bd96-53e5-ac9c-3500" name="Ignores Cover" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="bd2b-a4a2-9661-4f45" name="Preferred Enemy" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Reroll to-hit and to-wound rolls of 1.</description>
    </rule>
    <rule id="2ea3-3ac4-1f4f-4183" name="Swarms" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <rule id="4598-78c5-24b1-072a" name="Extremely Bulky" book="Warhammer 40k rulebook" page="35" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>Extremely ulky models count as five models for the purposes of Transport Capacity.</description>
    </rule>
    <rule id="a35b-4acd-ccc2-2b4d" name="Hatred" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>A model striking a hated foe in close combat re-rolls all misses during the first round of each combat - he does not get to make re-rolls for Hatred in subsequent rounds.</description>
    </rule>
    <rule id="484d-580b-674c-520f" name="Combi-Weapon" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
      <description>The non-Boltgun weapon half of a Combi-weapon is One Use Only.

A model armed with a combi-weapon can choose to fire either the main boltgun, or the secondary weapon. You cannot fire both in the same turn. Each combi-weapon has only one secondary weapon. The main and secondary weapons of a combi-weapon fire at the
same time as all other similarly named weapons in that unit. For example, the ‘boltgun’ part of a combi-weapon fires at the same time as all other boltguns in the unit.</description>
    </rule>
    <rule id="569a-900e-8b7d-2653" name="Skyfire" hidden="false">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
...
Unless otherwise stated, Poisoned weapons are treated as having a Strength of 1. The Poisoned special rule has no effect against vehicles.</description>
  ...
  <sharedProfiles>
    ...
    <profile id="73d5-cc81-ffd9-3393" name="Flamer" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <profile id="f585-411d-dacc-cabc" name="Meltagun" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
    ...
    <profile id="f922-9f18-5263-c23a" name="Plasma Gun" hidden="false" profileTypeId="d5f97c0b-9fc9-478d-aa34-a7c414d3ea48" profileTypeName="Weapon">
      <profiles/>
      <rules/>
      <infoLinks/>
      <modifiers/>
